...
var gr = (i, h, m, y, p, _) => ({
  canvas: i,
  addCircle: () => {
    const a = new import_fabric.fabric.Circle({
      ...br,
      fill: h,
      stroke: m
    });
  ...
  addRectangle: () => {
    const a = new import_fabric.fabric.Rect({
      ...Er,
      fill: h,
      stroke: m
    });
  ...
  addLine: () => {
    const a = new import_fabric.fabric.Line(we.points, {
      ...we.options,
      stroke: m
    });
    i.add(a);
  ...
  addText: (a) => {
    const c = new import_fabric.fabric.Textbox(a, {
      ...ee,
      fill: m
    });
    c.set({
...
var _r = (i = {}) => {
  ...
  } = i, [p, _] = (0, import_react.useState)(null), [a, c] = (0, import_react.useState)(m || re), [f, w] = (0, import_react.useState)(y || Y), [b, R] = (0, import_react.useState)([]);
...
function mr() {
  return Pe || (Pe = 1, function() {
    ...
    var We = false, $e = false, Ye = false, Ne = false, Ve = false, te;
...
` + o[d].replace(" at new ", " at ");
        ...
        G = false, J.current = l, Be(), Error.prepareStackTrace = u;
      }
    ...
    function tr(e, r) {
      if (typeof e.ref == "string" && I.current && r && I.current.stateNode !== r) {
        ...
        K[t] || (E('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', C(I.current.type), e.ref), K[t] = true);
      }
    }
    function nr(e, r) {
      {
        var t = function() {
          ge || (ge = true, E("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
    ...
    function ar(e, r) {
      {
        var t = function() {
          he || (he = true, E("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
...
Check the top-level render call using <` + t + ">.");
    ...
    function fr(e, r, t) {
      return Oe(e, r, t, true);
    }
    function dr(e, r, t) {
      return Oe(e, r, t, false);
    }
    var vr = dr, pr = fr;
...
(function(i) {
  false ? i.exports = hr() : i.exports = mr();
})(Fe);
var xe = Fe.exports.jsx;
var Tr = ({
  className: i,
  onReady: h
}) => {
  const m = (0, import_react.useRef)(null), y = (0, import_react.useRef)(null);
  return (0, import_react.useEffect)(() => {
    const p = new import_fabric.fabric.Canvas(m.current), _ = () => {
      var c, f;
      p.setHeight(((c = y.current) == null ? void 0 : c.clientHeight) || 0), p.setWidth(((f = y.current) == null ? void 0 : f.clientWidth) || 0), p.renderAll();
    }, a = () => {
      _();
    };
    return _(), window.addEventListener("resize", a, false), h && h(p), () => {
...
fabricjs-react/dist/fabricjs-react.es.js:
  (**
   * @license React
...
fabricjs-react/dist/fabricjs-react.es.js:
   ...
   *)
*/
//# sourceMappingURL=fabricjs-react.js.map
